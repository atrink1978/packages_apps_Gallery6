...
package com.android.gallery6d.filtershow;
...
import com.android.gallery6d.app.AbstractPermissionActivity;
import com.android.gallery6d.app.PhotoPage;
import com.android.gallery6d.data.LocalAlbum;
import com.android.gallery6d.filtershow.cache.ImageLoader;
import com.android.gallery6d.filtershow.category.Action;
import com.android.gallery6d.filtershow.category.CategoryAdapter;
import com.android.gallery6d.filtershow.category.CategoryPanelLevelTwo;
import com.android.gallery6d.filtershow.category.CategoryView;
import com.android.gallery6d.filtershow.category.EditorCropPanel;
import com.android.gallery6d.filtershow.category.MainPanel;
import com.android.gallery6d.filtershow.category.StraightenPanel;
import com.android.gallery6d.filtershow.category.SwipableView;
import com.android.gallery6d.filtershow.category.TruePortraitMaskEditorPanel;
import com.android.gallery6d.filtershow.category.TrueScannerPanel;
import com.android.gallery6d.filtershow.data.FilterPresetSource;
import com.android.gallery6d.filtershow.data.FilterPresetSource.SaveOption;
import com.android.gallery6d.filtershow.category.WaterMarkView;
import com.android.gallery6d.filtershow.data.UserPresetsManager;
import com.android.gallery6d.filtershow.editors.Editor;
import com.android.gallery6d.filtershow.editors.EditorCrop;
import com.android.gallery6d.filtershow.editors.EditorDualCamFusion;
import com.android.gallery6d.filtershow.editors.EditorManager;
import com.android.gallery6d.filtershow.editors.EditorPanel;
import com.android.gallery6d.filtershow.editors.EditorStraighten;
import com.android.gallery6d.filtershow.editors.EditorTruePortraitFusion;
import com.android.gallery6d.filtershow.editors.EditorTruePortraitImageOnly;
import com.android.gallery6d.filtershow.editors.EditorTruePortraitMask;
import com.android.gallery6d.filtershow.editors.HazeBusterEditor;
import com.android.gallery6d.filtershow.editors.ImageOnlyEditor;
import com.android.gallery6d.filtershow.editors.SeeStraightEditor;
import com.android.gallery6d.filtershow.editors.TrueScannerEditor;
import com.android.gallery6d.filtershow.filters.FilterDualCamBasicRepresentation;
import com.android.gallery6d.filtershow.filters.FilterDualCamFusionRepresentation;
import com.android.gallery6d.filtershow.filters.FilterMirrorRepresentation;
import com.android.gallery6d.filtershow.filters.FilterPresetRepresentation;
import com.android.gallery6d.filtershow.filters.FilterRepresentation;
import com.android.gallery6d.filtershow.filters.FilterRotateRepresentation;
import com.android.gallery6d.filtershow.filters.FilterUserPresetRepresentation;
import com.android.gallery6d.filtershow.filters.FilterWatermarkRepresentation;
import com.android.gallery6d.filtershow.filters.FiltersManager;
import com.android.gallery6d.filtershow.filters.ImageFilter;
import com.android.gallery6d.filtershow.filters.SaveWaterMark;
import com.android.gallery6d.filtershow.filters.SimpleMakeupImageFilter;
import com.android.gallery6d.filtershow.filters.TrueScannerActs;
import com.android.gallery6d.filtershow.history.HistoryItem;
import com.android.gallery6d.filtershow.history.HistoryManager;
import com.android.gallery6d.filtershow.imageshow.ImageShow;
import com.android.gallery6d.filtershow.imageshow.MasterImage;
import com.android.gallery6d.filtershow.imageshow.Spline;
import com.android.gallery6d.filtershow.info.InfoPanel;
import com.android.gallery6d.filtershow.mediapicker.MediaPickerFragment;
import com.android.gallery6d.filtershow.pipeline.CachingPipeline;
import com.android.gallery6d.filtershow.pipeline.ImagePreset;
import com.android.gallery6d.filtershow.pipeline.ProcessingService;
import com.android.gallery6d.filtershow.presets.PresetManagementDialog;
import com.android.gallery6d.filtershow.presets.UserPresetsAdapter;
import com.android.gallery6d.filtershow.provider.SharedImageProvider;
import com.android.gallery6d.filtershow.state.StateAdapter;
import com.android.gallery6d.filtershow.tools.DualCameraEffect;
import com.android.gallery6d.filtershow.tools.FilterGeneratorNativeEngine;
import com.android.gallery6d.filtershow.tools.SaveImage;
import com.android.gallery6d.filtershow.tools.TruePortraitNativeEngine;
import com.android.gallery6d.filtershow.tools.XmpPresets;
import com.android.gallery6d.filtershow.tools.XmpPresets.XMresults;
import com.android.gallery6d.filtershow.ui.ExportDialog;
import com.android.gallery6d.filtershow.ui.FramedTextButton;
import com.android.gallery6d.util.GalleryUtils;
